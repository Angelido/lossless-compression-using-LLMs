...
Description:
    ...
    samples using a quantized version of Llama3.1-8B (4 bit).
...
Output:
    TextInformation/Llama3.1_8B_Quantized_rank_list.txt
...
save_rank_list_to_file(
    ...
    file_path="TextInformation/Llama3.1_8B_Quantized_rank_list.txt",
