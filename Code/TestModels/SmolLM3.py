...
Description:
    ...
    samples using a version of SmolLM3.
...
Output:
    TextInformation/SmolLM3_rank_list.txt
...
# Model name
model_name = "HuggingFaceTB/SmolLM3-3B" # Not quantized
...
save_rank_list_to_file(
    ...
    file_path="TextInformation/SmolLM3_rank_list.txt",
