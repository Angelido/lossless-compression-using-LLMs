...
from computeEntropy import compute_entropy_unixcoder, compute_cross_entropy_unixcoder
from utility import (
...
if cross_entropy:
    ...
    total_bits, total_tokens, timings = compute_cross_entropy_unixcoder(
        dataloader, 
        model, 
        PAD_TOKEN_ID, 
        device, 
    ...
    total_bits, total_tokens, timings = compute_entropy_unixcoder(
        dataloader,
        model,
        PAD_TOKEN_ID,
        device,
