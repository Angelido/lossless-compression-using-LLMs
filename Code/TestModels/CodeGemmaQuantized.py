...
Output:
    TextInformation/CodeGemma_Quantized_rank_list.txt
...
save_rank_list_to_file(
    ...
    file_path="TextInformation/CodeGemma_Quantized_rank_list.txt",
